export function loadEditRowConfirmationModal() {
  const bodyContent = `
<div class="modal fade" id="editRowConfirmationModal" tabindex="-1" aria-labelledby="confirmationModalLabel" aria-hidden="true">
  ...
  document.getElementById('edit-row-confirmation-modal-container').appendChild(bodyElement);
}

// Cargar el modal en el DOM
loadEditRowConfirmationModal();
